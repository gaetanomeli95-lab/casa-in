...
export default function Showroom() {
  ...
  return (
    <section id="showroom" ref={ref} className="bg-ink text-white overflow-hidden">
      <div className="grid lg:grid-cols-[1.15fr_0.85fr] min-h-[760px]">
        <div className="relative h-[460px] lg:h-auto overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-black/55 via-transparent to-black/5 lg:bg-gradient-to-r lg:from-transparent lg:via-transparent lg:to-black/30" />
          <div className="absolute left-6 bottom-6 md:left-8 md:bottom-8 bg-black/55 border border-white/12 px-5 py-4 max-w-[320px] backdrop-blur-sm">
            <span className="text-[8px] font-extrabold tracking-[0.16em] text-[#ff8b8e]">CASA IN · CARINI</span>
            <p className="font-serif text-xl leading-snug mt-1">Vieni a vedere da vicino le composizioni e i materiali.</p>
          </div>
        </div>

        <div className="relative flex flex-col justify-center px-8 lg:px-14 xl:px-20 py-20 lg:py-24">
          <div className="absolute top-12 right-10 text-[130px] font-serif italic text-white/[0.03] leading-none select-none pointer-events-none">IN</div>
          ...
          <motion.h2
            ...
            className="font-serif text-[clamp(42px,5.4vw,82px)] leading-[0.96] tracking-tight text-white"
          >
            Vieni a vederla.
            <br />
          ...
          <motion.p
            ...
            className="mt-8 max-w-[540px] text-[15px] leading-[1.8] text-white/55"
          >
          ...
          >
            <div className="grid grid-cols-[95px_1fr] md:grid-cols-[110px_1fr] gap-5 py-5 border-b border-white/12">
          ...
          >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-3 h-14 px-7 border border-white/25 text-white text-[10px] font-extrabold uppercase tracking-widest hover:bg-white hover:text-ink transition-colors"
            >
              Indicazioni
            </a>
          </motion.div>
